...
public class UserServiceTest {
    ...
    @Test
    public void test_create_user() throws ServiceException {
...
// ...
    ...
    @Test
    public void Test_Create_user_exeption()throws ServiceException
    {
        Utilisateur utilisateur = new Utilisateur("Jean", "Dupont",
                "jeandupont@email.com");
    ...
    @Test
    public void Test_Create_user_error_validation()throws ServiceException
    {
    ...
    @Test
    public void Test_Create_user_id() throws ServiceException {
    ...
    @Test
    public void Test_Create_user_capture()throws ServiceException
    {
        Utilisateur utilisateur = new Utilisateur("Jean", "Dupont", "jeandupont@email.com");
