...
public class Test_jeu {
    ...
    @Test
    public void Test_ferme() throws JeuFermeException, DebitImpossibleException {
    ...
    @Test
    public void test_insolvable() throws DebitImpossibleException {
        Banque bank=mock(Banque.class);
    ...
    @Test
    public void test_bank_insolvable_apres_gain(){
